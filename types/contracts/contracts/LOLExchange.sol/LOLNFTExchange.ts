...
export interface LOLNFTExchangeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buyNFT"
      | "createListing"
  ...
  encodeFunctionData(functionFragment: "lol", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "lol", data: BytesLike): Result;
...
export interface LOLNFTExchange extends BaseContract {
  connect(runner?: ContractRunner | null): LOLNFTExchange;
  waitForDeployment(): Promise<this>;

  interface: LOLNFTExchangeInterface;
  ...
  lol: TypedContractMethod<[], [string], "view">;
  ...
  filters: {
    "ListingCreated(uint256,uint256,address,uint256)": TypedContractEvent<
      ListingCreatedEvent.InputTuple,
      ListingCreatedEvent.OutputTuple,
      ListingCreatedEvent.OutputObject
    >;
