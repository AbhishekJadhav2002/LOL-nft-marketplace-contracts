...
export interface LOLInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  decodeFunctionResult(functionFragment: "laugh", data: BytesLike): Result;
...
export interface LOL extends BaseContract {
  connect(runner?: ContractRunner | null): LOL;
  ...
  laugh: TypedContractMethod<
    [person: AddressLike, tokenURI: string],
    [bigint],
    "nonpayable"
  >;
